        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AccountStatus = table.Column<int>(type: "int", maxLength: 50, nullable: false, defaultValue: 0),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PassScore = table.Column<decimal>(type: "decimal(5,2)", precision: 5, scale: 2, nullable: false, defaultValue: 60.00m),
            ...
            migrationBuilder.CreateIndex(
                name: "UQ_AttemptAnswers_AttemptId_QuestionId",
                table: "AttemptAnswers",
            ...
            migrationBuilder.CreateIndex(
                name: "UQ_Enrollments_StudentId_DiplomaId",
                table: "Enrollments",
            ...
            migrationBuilder.CreateIndex(
                name: "UQ_QuizAttempts_StudentId_QuizId_InProgress",
                table: "QuizAttempts",
                columns: new[] { "StudentId", "QuizId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Quizzes_DiplomaId_Status",
                table: "Quizzes",
                columns: new[] { "DiplomaId", "Status" });
        }
